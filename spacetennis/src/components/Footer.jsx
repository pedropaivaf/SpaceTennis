      ...
      <div className="container mx-auto flex flex-col items-center justify-center">
        ...
        <div className="flex justify-center gap-8 mb-6">
          <a href="https://www.instagram.com/seuusuario" target="_blank" rel="noopener noreferrer">
            <FaInstagram size={30} className="text-pink-600 hover:text-pink-400 transition" />
          </a>
          <a href="https://www.facebook.com/seuusuario" target="_blank" rel="noopener noreferrer">
            <FaFacebook size={30} className="text-blue-600 hover:text-blue-400 transition" />
          </a>
          <a href="https://twitter.com/seuusuario" target="_blank" rel="noopener noreferrer">
            <FaTwitter size={30} className="text-blue-400 hover:text-blue-300 transition" />
          </a>
        </div>
        <div className="text-center mb-6">
          <p className="text-lg"><FaEnvelope className="inline mr-2" /> seuemail@dominio.com</p>
          <p className="text-lg"><FaPhone className="inline mr-2" /> (XX) 1234-5678</p>
        </div>
        <div>
